...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240911154515_mig_BookingDescription_Nullable")]
    partial class mig_BookingDescription_Nullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityLayer.Entities.Basket", b =>
                {
                    ...
                    b.ToTable("Baskets", null, t =>
                        {
                            t.HasTrigger("ActiveTable");

                            t.HasTrigger("TotalPriceCounting");
                        });
            ...
            modelBuilder.Entity("EntityLayer.Entities.Booking", b =>
                {
                    ...
                    b.ToTable("Bookings", null, t =>
                        {
                            t.HasTrigger("trg_AfterInsertBookings");
                        });
            ...
            modelBuilder.Entity("EntityLayer.Entities.Order", b =>
                {
                    ...
                    b.ToTable("Orders", null, t =>
                        {
                            t.HasTrigger("SumMoneyCases");

                            t.HasTrigger("trg_AfterInsertOrders");
                        });
            ...
            modelBuilder.Entity("EntityLayer.Entities.OrderDetail", b =>
                {
                    ...
                    b.ToTable("OrderDetails", null, t =>
                        {
                            t.HasTrigger("DecreaseOrderTotalPrice");

                            t.HasTrigger("IncreaseOrderTotalPrice");
                        });
            ...
            modelBuilder.Entity("EntityLayer.Entities.Basket", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Entities.Table", "Table")
                        .WithMany("Baskets")
